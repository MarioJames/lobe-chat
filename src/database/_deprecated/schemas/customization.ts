 ...
 * - 各配置字段都是可选的 JSONB
 */
export const customizationConfig = pgTable('customization_config', {
  // ========== 固定 ID（始终为 1）==========
...
export type CustomizationConfigSelectItem = typeof customizationConfig.$inferSelect;
export type NewCustomizationConfigItem = typeof customizationConfig.$inferInsert;
