...
const RoleGuard = memo(() => {
  ...
  useFetchCurrentUserRoles({
    enabled: !isDesktop && isLoaded && isLoginWithAuth,
  });

  // Only check roles in web mode (not desktop)
  const shouldCheckRoles = !isDesktop;
    ...
    <Center className={styles.overlay}>
      <Card className={styles.card}>
        <Flexbox align="center" className={styles.container}>
          ...
          <Button className={styles.button} type="primary" onClick={handleRefresh}>
