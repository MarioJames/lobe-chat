 ...
 * - search: string (optional) - 搜索关键词（匹配名称或描述）
 * - type: string (optional) - 类型过滤（personal/shared）
 * - enabled: boolean (optional) - 是否只查询启用的知识库
 */
app.get(
  '/',
  requireAuth,
 ...
 *   "avatar": "头像URL（可选）",
 *   "type": "personal | shared（可选，默认personal）",
 ...
 * - search: string (optional) - 搜索关键词（匹配文件名）
 *
 * 说明：
